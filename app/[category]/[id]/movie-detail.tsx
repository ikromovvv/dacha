        ...
        return (
            <div className="min-h-screen bg-background text-foreground flex items-center justify-center">
                <div className="text-center">
                    ...
                    <button className="inline-flex items-center gap-2 px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity">
                        <ArrowLeft size={20} />
                        Back to Home
                    </button>
                </div>
        ...
        <div className="min-h-screen bg-background text-foreground container mx-auto sm:px-[25px] px-[15px] py-[15px]">
            ...
            <div className="mt-8">
                ...
                <List
                    ...
                    dataSource={comments}
                    renderItem={(item) => (
                        <div className="p-4 border rounded-lg bg-gray-50 mt-[10px] mb-[10px] flex justify-between items-start">
